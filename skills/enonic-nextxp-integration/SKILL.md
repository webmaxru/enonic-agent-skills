...
6. Read `references/compatibility.md` to confirm version requirements between `@enonic/nextjs-adapter` (v5.x), Next.js (16+), React (19), and Enonic XP (8.x).
...
4. For page components (pages, parts, layouts):
   a. Define the component descriptor in the Enonic app. For Enonic XP 8, use YAML format under `src/main/resources/cms/pages/`, `parts/`, or `layouts/`. For Enonic XP 7, use XML format under `src/main/resources/site/pages/`, `parts/`, or `layouts/`.
