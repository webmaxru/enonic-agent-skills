...
6. Read `references/compatibility.md` to confirm version requirements between `@enonic/nextjs-adapter` (v5.x), Next.js (16+), React (19), Node.js (≥ 24.15.0), and Enonic XP.
